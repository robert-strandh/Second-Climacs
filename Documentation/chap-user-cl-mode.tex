...
\begin{itemize}
\item \texttt{Forward expression} (C-M-f).  If the cursor is positioned
  between two expressions, then it will be moved so that it is
  positioned immediately after the expression to the right.  If the
  ...
  that comments count as expressions for this command.
