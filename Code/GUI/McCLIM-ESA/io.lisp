...
(defmethod buf:frame-make-new-buffer ((frame climacs) &key)
...
(defmethod io:frame-find-file :around ((frame climacs) file-path)
...
(defmethod io:check-buffer-writability
