...
The results are shown in \refTab{t-insert-delete-parenthesis}.
...
As shown in \refTab{t-insert-delete-parenthesis}, the performance is
...
\noindent
As \refTab{t-insert-delete-double-quote} shows, these execution times
